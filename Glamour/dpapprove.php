...
session_start();
    ...
    function sendMail($email, $booking_id, $lastname)
    {
        ...
        try {
            ...
            <p style='color: #fff;'>
            Please find the attached receipt for your <a href='localhost/Glamour/dpinvoice.php?booking_id=$booking_id'><span style='color: #FED586;'>downpayment receipt link </span> </a>here. It serves as confirmation of your payment and 

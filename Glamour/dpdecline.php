...
session_start();
    ...
    function sendMail($email, $booking_id, $lastname, $amount)
    {
        ...
        try {
            ...
            $mail->Subject = 'Glamour: Payment Declined for Downpayment | Request to Retry Billing';
            $mail->Body    = "
            ...
            development regarding the downpayment for your upcoming event, and I kindly 
            request your attention to rectify the matter.<br><br>
            </p>

            <p style='color: #fff;'>
            Upon processing the payment for the downpayment amount of $amount, we encountered an issue, 
            ...
            request you to retry the billing of the downpayment. I have attached the same payment 
    ...
    if(isset($_GET['dpadeclineid']) && isset($_GET['billing']) ){
        $id = $_GET['dpdeclineid'];
        $billing = $_GET['billing'];
        $select = "UPDATE billing SET dpstatus = 'Declined' WHERE id = '$id' ";

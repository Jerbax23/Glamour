        ...
        if(strtotime($bookdate) < time()) {
            ...
            //
                        if(empty($_POST['guests']) || empty($_POST['venue'])  || empty( $_POST['cuisine'])  || empty( $_POST['style']) || empty( $_POST['theme'])  || empty( $_POST['checkbox']))
                        {
                            ...
                            //$sql_booking = "INSERT INTO booking (user_id, booking_id, firstname, lastname, phone, address, emailadd, bookdate, weektype, event, amount, status, coordinator_1, coordinator_2, coordinator_3, coordinator_4) VALUES ('$id', '$newid', '$firstname', '$lastname', '$phone', '$address', '$emailadd', '$bookdate', '$weektype', 'Wedding', '$finalPrice', 'pending', '$coordinator1', '$coordinator2', '$coordinator3', '$coordinator4' )";
                            //$result = mysqli_query($connection, $sql_booking);
                            $sql_booking = "INSERT INTO booking (user_id, booking_id, firstname, lastname, phone, address, emailadd, bookdate, weektype, event, amount, downpayment, venueprice, cuisineprice, styleprice, serviceprice, status, coordinator_1, coordinator_2, coordinator_3, coordinator_4) VALUES ('$id', '$newid', '$firstname', '$lastname', '$phone', '$address', '$emailadd', '$bookdate', '$weektype', 'Wedding', '$finalPrice', '$downPayment', '$venuePrice', '$cuisinePrice', '$stylePrice', '$totalPrice', 'pending', '$coordinator1', '$coordinator2', '$coordinator3', '$coordinator4' )";
                            $result = mysqli_query($connection, $sql_booking);
        
                            $sql_booking2 = "INSERT INTO wedding (user_id, booking_id, venue, guest_number, cuisine, style, theme_design, extra_services, other_preferences) VALUES ('$id', '$newid', '$venue', '$guests', '$cuisine', '$style', '$theme', '$services', '$message' )";
                            $result2 = mysqli_query($connection, $sql_booking2);

                            //pwede rin iinclude ung result3 sa if else statement or ilagay sa loob ng if else statement para pag successful auto malalagay 
                            if($result && $result2)
                            {
...
<head>
    ...
    <title>Book a Wedding | Glamour</title>
...
<body>
    ...
    <div class="booking-form" id="booking-form">
        <div class="col1">
            ...
            <div class="bookpic">
                <img src="CSS/Pictures/wedding/weddingbookdisplay.png" style="width: 100%;">
            </div>
        </div>
        <div class="col2">
        <h2>Venue</h2>
            ...
            <select id="cuisine" name="cuisine">
                ...
                <option value="None" style="color: #999;">None</option>
            </select>

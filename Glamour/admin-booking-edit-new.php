...
session_start();
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql_booking = "UPDATE booking SET firstname = '$firstname', lastname = '$lastname', address = '$address', phone = '$phone', emailadd = '$emailadd', bookdate = '$bookdate' WHERE id = '$editid' ";
        ...
        if($result) {
            ...
            if(mysqli_num_rows($birthresult)>0){
                ...
                if(empty($_POST['age']) || empty($_POST['guests']) || empty( $_POST['gender']) || 
                empty($_POST['venue'])  || empty( $_POST['cuisine'])  || empty( $_POST['style']) || 
                empty( $_POST['theme'])  || empty( $_POST['checkbox'])) {
                    ...
                    // Retrieve the price based on the venue
                            ...
                            $venueQuery = "SELECT $priceColumn FROM venues WHERE venuename = '$venue' AND venuetype = 'Wedding' ";
                            ...
                            $styleQuery = "SELECT price FROM prices WHERE price_name = '$style' AND price_guestnum = '$guests' AND price_event = 'Wedding' ";
                    ...
                    //echo " Services Price: $totalPrice";
                    ...
                    $sql_booking2 = "UPDATE birthday SET upcoming_age = '$age', celeb_gender = '$gender', venue = '$venue', guest_number = '$guests', cuisine = '$cuisine', style = '$style', theme_design = '$theme', extra_services = '$services', other_preferences = '$message' WHERE booking_id = '$booking' ";
            ...
            if(mysqli_num_rows($weddingresult)>0){
                ...
                $downPayment = $finalPrice / 2;
                    ...
                    $sql_booking2 = "UPDATE wedding SET venue = '$venue', guest_number = '$guests', cuisine = '$cuisine', style = '$style', theme_design = '$theme', extra_services = '$services', other_preferences = '$message' WHERE booking_id = '$booking' ";
                    $result2 = mysqli_query($connection, $sql_booking2);
            ...
            if(mysqli_num_rows($anniversaryresult)>0){
                ...
                if(empty($_POST['guests']) || empty($_POST['venue']) || empty( $_POST['cuisine'])  || empty( $_POST['style']) || empty( $_POST['theme'])  || empty( $_POST['checkbox']))
                {
                    ...
                    $sql_booking2 = "UPDATE anniversary SET venue = '$venue', guest_number = '$guests', cuisine = '$cuisine', style = '$style', theme_design = '$theme', extra_services = '$services', other_preferences = '$message' WHERE booking_id = '$booking' ";
                    $result2 = mysqli_query($connection, $sql_booking2);

                    if(in_array('DJ Services', $checkbox)){
                        $checksql = "UPDATE anniversary SET dj_services = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET dj_services = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
                    if(in_array('Emcee', $checkbox)){
                        $checksql = "UPDATE anniversary SET emcee = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET emcee = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
                    if(in_array('Photographer', $checkbox)){
                        $checksql = "UPDATE anniversary SET photographer = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET photographer = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } 
                    if(in_array('Videographer', $checkbox)){
                        $checksql = "UPDATE anniversary SET videographer = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET videographer = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
                    if(in_array('Makeup Artist', $checkbox)){
                        $checksql = "UPDATE anniversary SET makeup_artist = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET makeup_artist = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
                    if(in_array('Bar Area', $checkbox)){
                        $checksql = "UPDATE anniversary SET bar_area = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET bar_area = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
                    if(in_array('Invitation Cards', $checkbox)){
                        $checksql = "UPDATE anniversary SET invitation_cards = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET invitation_cards = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
                    if(in_array('None', $checkbox)){
                        $checksql = "UPDATE anniversary SET none = 1 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    } else {
                        $checksql = "UPDATE anniversary SET none = 0 WHERE booking_id = '$booking' ";
                        mysqli_query($connection, $checksql);
                    }
            ...
            if(mysqli_num_rows($christeningresult)>0){
                ...
                if(empty($_POST['guests']) || empty( $_POST['gender']) || empty($_POST['venue'])  || empty( $_POST['cuisine']) || empty( $_POST['style']) || empty( $_POST['theme'])  || empty( $_POST['checkbox'])){
                    ?><script type="text/javascript">
                    alert('Some fields are missing data. Please try again');
                    window.history.back();
                    </script>
                    ...
                    $sql_booking2 = "UPDATE christening SET celeb_gender = '$gender', venue = '$venue', guest_number = '$guests', cuisine = '$cuisine', style = '$style', theme_design = '$theme', extra_services = '$services', other_preferences = '$message' WHERE booking_id = '$booking' ";
                    $result2 = mysqli_query($connection, $sql_booking2);
            ...
            if(mysqli_num_rows($corporateresult)>0){
                ...
                if(empty($_POST['guests']) || empty($_POST['venue'])  || empty( $_POST['cuisine']) || empty( $_POST['style']) || empty( $_POST['theme'])  || empty( $_POST['checkbox'])){
                    ...
                    $sql_booking2 = "UPDATE corporate SET venue = '$venue', guest_number = '$guests', cuisine = '$cuisine', style = '$style', theme_design = '$theme', extra_services = '$services', other_preferences = '$message' WHERE booking_id = '$booking' ";
                    $result2 = mysqli_query($connection, $sql_booking2);

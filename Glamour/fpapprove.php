...
session_start();
    ...
    function sendMail($email, $booking_id, $lastname, $amount)
    {
        ...
        try {
            ...
            //Attachments
            $invoicefile = 'Glamour/fpinvoice.php';
            ...
            <p style='color: #fff;'>
            Please find attached the receipt for your fullpayment. It serves as confirmation of your payment and 
    ...
    if(isset($_GET['fpapproveid']) && isset($_GET['billing'])){
        ...
        $query = "SELECT * FROM billing WHERE booking_id = '$billing'";
        ...
        if($select){
            if(sendMail($emailadd, $billing_id, $lastname, $amount)){

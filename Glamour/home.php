...
<body id="wedding-body">
    ...
    <header>
        ...
        <div class="navbar" >
        <ul>
            <li><a href="home.php" class="active" style="font-size: .8em">HOME</a></li>
    ...
    <section class="banner" id="banner">
        <div class="home-banner">
            ...
            <div class="book-button">
                <a href="events.php"><button class="book-event">BOOK AN EVENT</button></a>
            </div>
            <div class="down">
    ...
    <section class="eventssec" id="eventssec">
        ...
        <div class="wedding">
            ...
            <div class="seemore-button">
                <a href="wedding.php"><button class="see-more">SEE MORE</button></a>
            </div>
        </div>
    ...
    <!--birthday section-->
        ...
        <div class="birthday">
            ...
            <div class="seemore-button">
                <a href="birthday.php"><button class="see-more">SEE MORE</button></a>
            </div>
        </div>
    ...
    <!--christening section-->
        <div class="lightbubble3" id="lightbubble3">
            ...
            <div class="christening">
                ...
                <div class="seemore-button">
                    <a href="christening.php"><button class="see-more">SEE MORE</button></a>
                </div>
            </div>
    ...
    <!--anniversary section-->
        <div class="lightbubble4" id="lightbubble4">
            ...
            <div class="anniversary">
                ...
                <p>&nbsp;</p>
                <div class="seemore-button">
                    <a href="anniversary.php"><button class="see-more">SEE MORE</button></a>
                </div>
            </div>
    ...
    <!--corporate section-->
        <div class="lightbubble5" id="lightbubble5">
            ...
            <div class="corporate">
                ...
                <p>events with us</p>
                <div class="seemore-button">
                    <a href="corporate.php"><button class="see-more">SEE MORE</button></a>
                </div>
            </div>
    </section>
    ...
    <section class="storysec" id="storysec">
        ...
        <div class="fullstory-button">
            <a href="about.php"><button class="full-story">FULL STORY</button></a>
        </div>
    </section>

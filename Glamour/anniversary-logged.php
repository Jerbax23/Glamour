...
<body id="anniv-body">
    ...
    <section class="anniv-banner" id="anniv-banner">
        <div class="anniv-banner-container">
            ...
            <div class="start-button">
                <a href="annivbook.php"><button class="get-started">GET STARTED</button></a>
            </div>
        </div>
    </section>
        ...
        <div class="anniv-row2">
            <div class="anniv-column2 anniv-left">
                ...
                <div class="startplanning-button">
                    <a href="annivbook.php"><button class="start-planning">START PLANNING NOW</button></a>
                </div>
            </div>
    ...
    <section class="ending-banner" id="ending-banner">
        ...
        <div class="start-button1">
            <a href="annivbook.php"><button class="get-started1">- GET STARTED -</button></a>
        </div>
    </section>

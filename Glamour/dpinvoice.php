<?php 
  ...
  class PDF extends FPDF{
    function Header(){
      ...
      $this->Cell(50,7,"Patricia Lodicakes",0,1);
      $this->Cell(50,7,"Lakas tama ko sayo",0,1);
    ...
    function body($info, $product_info){
      ...
      $this->SetFont('Arial','B',12);
      $this->Cell(150,9,"TOTAL AMOUNT CURRENTLY PAID",1,0,"R");
      $this->Cell(40,9,$info["downpayment"],1,1,"R");

      $this->Cell(150,9,"CURRENT REMAINING BALANCE THAT NEEDS TO BE PAID",1,0,"R");
      $this->Cell(40,9,$info["downpayment"],1,1,"R");
      ...
      $this->SetX(10);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,9,"Next amount to complete the transaction",0,1);
      $this->SetFont('Arial','',12);
      $this->Cell(0,9,"PHP ".$info["downpayment"],0,1);
    ...
    function Footer(){
      ...
      $this->Ln(5);
      $this->SetFont('Arial','',12);
      $this->Cell(0,5,"Thank you for using Glamour, please pay on time :)",0,1,"R");
      $this->SetFont('Arial','',10);
      
      //Display Footer Text
      $this->Cell(0,30,"This is a Glamour computer generated invoice",0,1,"C");

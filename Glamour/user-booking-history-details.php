                            ...
                            <div class="modal-content" style="background: #383838; width: 50%;  border-radius: 20px;">
                                ...
                                <div class="grid-container2">
                                    <div class="column1">
                                        ...
                                        <p style="height: 30px; font-size: 13px; padding: 5px 15px;"><?php echo $bookrow['amount']; ?></p>
                                    </div>
                                    <div class="column2">
                                        <h3 style="font-family: Poppins; color: var(--text-color);">Downpayment Cost</h3>
                                        <p style="height: 30px; font-size: 13px; padding: 5px 15px;"><?php echo ($bookrow['amount'])/2; ?></p>
                                    </div>
                                </div>
